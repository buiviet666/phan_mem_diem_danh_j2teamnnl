                                ...
                                <div class="card-body">
                                    ...
                                    <div class="my-4 chartjs-chart" style="height: 202px;">
                                        <canvas id="project-status-chart"
                                            data-colors="#10c469,#536de6,#ff5b5b"></canvas>
                                    </div>
                                        ...
                                        <table class="table table-centered table-nowrap table-hover mb-0">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <h5 class="font-14 my-1"><a href="javascript:void(0);"
                                                                class="text-body">Coffee detail page - Main
                                                                Page</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h5 class="font-14 my-1"><a href="javascript:void(0);"
                                                                class="text-body">Drinking bottle graphics</a>
                                                        </h5>
                                                    ...
                                                    <td>
                                                        <span class="text-muted font-13">Assigned to</span>
                                                        <h5 class="font-14 mt-1 font-weight-normal">Jerry F. Powell
                                                        </h5>
                                                    </td>
                                                    <td>
                                                        <span class="text-muted font-13">Total time spend</span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h5 class="font-14 my-1"><a href="javascript:void(0);"
                                                                class="text-body">App design and development</a>
                                                        </h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h5 class="font-14 my-1"><a href="javascript:void(0);"
                                                                class="text-body">Poster illustation design</a>
                                                        </h5>
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                <h5 class="mt-0 mb-1">Soren Drouin<small
                                                                        class="font-weight-normal ml-3">18 Jan 2019
                                                                        11:28 pm</small></h5>
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                <h5 class="mt-0 mb-1">Anne Simard<small
                                                                        class="font-weight-normal ml-3">18 Jan 2019
                                                                        11:09 pm</small></h5>
                                                                <span class="font-13">Assigned task "Poster
                                                                    illustation design"...</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                <h5 class="mt-0 mb-1">Nicolas Chartier<small
                                                                        class="font-weight-normal ml-3">15 Jan 2019
                                                                        09:29 pm</small></h5>
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                <h5 class="mt-0 mb-1">Gano Cloutier<small
                                                                        class="font-weight-normal ml-3">10 Jan 2019
                                                                        08:36 pm</small></h5>
                                                                <span class="font-13">Completed "Design new
                                                                    idea"...</span>
                                                            </div>
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                <h5 class="mt-0 mb-1">Francis Achin<small
                                                                        class="font-weight-normal ml-3">08 Jan 2019
                                                                        12:28 pm</small></h5>
